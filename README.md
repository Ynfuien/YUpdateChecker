...
- [API](https://github.com/Ynfuien/YUpdateChecker/wiki/4.-Developer-API) for developers

# Download
You can download the plugin only on [Modrinth](https://modrinth.com/plugin/yvanish) or compile it yourself.

# Documentation
You can read about plugin's [permissions](https://github.com/Ynfuien/YUpdateChecker/wiki/2.-Permissions), [placeholders](https://github.com/Ynfuien/YUpdateChecker/wiki/3.-Placeholders) etc. on the [wiki](https://github.com/Ynfuien/YUpdateChecker/wiki) page.
